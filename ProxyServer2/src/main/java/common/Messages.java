...
public class Messages {
	 ...
	 public static final String READ_HEADER_ERR = "Error while reading headers from input stream.";
	    ...
	    public static final String ILLEGAL_REQUEST_ERR = "Illegal Request";
	    public static final String BUILD_REQUEST_ERR = "Error creating Request";
	    public static final String ILLEGAL_RESPONSE = "Illegal Response";
